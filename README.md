...
```
webcam ─▶ FaceLandmarker(468pt, GPU) ─▶ EMA 안정화
                                            │
   ┌────────────────────────────────────────┘
   ▼
...
├─ vision/      FaceLandmarker 래퍼 · EMA 랜드마크 안정화 · 적응형 얼굴 분석 · 세그멘테이션
...
| 안정화 | 지수이동평균(EMA) — 랜드마크 떨림 억제 (One Euro Filter는 후속 후보) |
